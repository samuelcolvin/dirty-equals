...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('foo', IsAnyStr(case='lower'), True),
        (b'foo', IsAnyStr(case='lower'), True),
        ('FOO', IsAnyStr(case='lower'), False),
        (b'FOO', IsAnyStr(case='lower'), False),
        ('FOO', IsAnyStr(case='upper'), True),
        (b'FOO', IsAnyStr(case='upper'), True),
        ('foo', IsAnyStr(case='upper'), False),
        (b'foo', IsAnyStr(case='upper'), False),
        ('foo', IsAnyStr(max_length=3), True),
        (b'foo', IsAnyStr(max_length=3), True),
        ('foobar', IsAnyStr(max_length=3), False),
        (b'foobar', IsAnyStr(max_length=3), False),
    ],
)
